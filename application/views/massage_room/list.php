        ...
        <a href="javascript:open_form();" class="btn btn-small btn-success"><i class="btn-icon-only icon-plus"></i>Add Massage Service</a>
			<div class="account-container" style="display: none;" id="form">
				<div class="content clearfix">
					<form action="<?=base_url()?>service/massage_room" method="post">
			...
			<hr>
			<a href="<?=base_url()?>massage_room/add" class="btn btn-small btn-primary"><i class="btn-icon-only icon-ok"></i>Add Massage Room</a>
			<br><br>
			<table class="table table-striped table-bordered">
				...
				?>
				  <tr>
				    ...
				    <td class="td-actions"><a href="<?=base_url()?>massage_room/edit/<?=$massage->massageroom_id?>" class="btn btn-small btn-primary"><i class="btn-icon-only icon-edit"> </i></a><a href="<?=base_url()?>massage_room/delete/<?=$massage->massageroom_id?>" onclick="return confirm('Are you sure ?')" class="btn btn-danger btn-small"><i class="btn-icon-only icon-remove"> </i></a></td>
				  </tr>
				<?php } ?>
				</tbody>
			</table>
